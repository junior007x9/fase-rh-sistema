        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
            <div className="p-4 border-b border-slate-100 bg-slate-50 flex flex-col gap-3">
              ...
              {/* COMPONENTE DE BUSCA EM TEMPO REAL AZUL */}
              <LiveSearch paramName="qCargo" defaultValue={qCargo} placeholder="Pesquisar cargo..." cor="blue" />
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
            <div className="p-4 border-b border-slate-100 bg-slate-50 flex flex-col gap-3">
              ...
              {/* COMPONENTE DE BUSCA EM TEMPO REAL ROXO */}
              <LiveSearch paramName="qLotacao" defaultValue={qLotacao} placeholder="Pesquisar lotação..." cor="purple" />
            </div>
